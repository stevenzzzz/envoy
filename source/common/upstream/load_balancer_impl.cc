...
ZoneAwareLoadBalancerBase::ZoneAwareLoadBalancerBase(
    ...
    const envoy::config::cluster::v3::Cluster::CommonLbConfig& common_config)
    : LoadBalancerBase(priority_set, runtime, random, common_config), stats_(cluster_info.zone),
      stats_(cluster_info.zoneawareLbStats()), local_priority_set_(local_priority_set),
