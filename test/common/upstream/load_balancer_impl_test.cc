...
protected:
  ...
  LoadBalancerTestBase()
      : stat_names_(stats_store_.symbolTable()), lb_stats_(stat_names_, stats_store_) {
...
public:
  TestLb(const PrioritySet& priority_set, ClusterLbStats& stats, Runtime::Loader& runtime,
         Random::RandomGenerator& random,
         const envoy::config::cluster::v3::Cluster::CommonLbConfig& common_config)
...
public:
  TestZoneAwareLb(const PrioritySet& priority_set, ClusterLbStats& stats, Runtime::Loader& runtime,
                  Random::RandomGenerator& random,
                  const envoy::config::cluster::v3::Cluster::CommonLbConfig& common_config)
      : ZoneAwareLoadBalancerBase(priority_set, nullptr, stats, runtime, random, common_config) {}
