...
public:
  ...
  ClusterSubsetsLbStatNames subsets_lb_stat_names_;
  ClusterZoneAwareLbStatNames zoneaware_lb_stat_names_;
  ...
  Stats::LazyInit<ClusterSubsetsLbStats> subsets_lb_stats_;
  Stats::LazyInit<ClusterZoneAwareLbStats> zoneaware_lb_stats_;
